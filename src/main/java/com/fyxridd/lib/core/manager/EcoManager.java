...
public class EcoManager {
    ...
    public double get(String name) {
        return eco.getBalance(config.getEcoDefaultWorld(), name);
    }
    ...
    public boolean add(String name, double amount) {
        return eco.depositPlayer(config.getEcoDefaultWorld(), name, amount).transactionSuccess();
    }
    ...
    public boolean del(String name, double amount) {
        return eco.withdrawPlayer(config.getEcoDefaultWorld(), name, amount).transactionSuccess();
    }
