...
public interface ChanceHashList<T extends Object> extends HashList<T>,Iterable<T>,Cloneable,Serializable{
	 ...
	 * @return 成功返回true,如果已经有此元素则返回false
	 */
	boolean addChance(T o, int chance);
	 ...
	 * @return 成功返回true,如果已经有此元素返回false
	 */
	boolean addChance(T o, int index, int chance);
	 ...
	 * @param chance 新的机率
	 */
	void setChance(int index, int chance);
	 ...
	 */
	boolean setChance(T o, int chance);
	 ...
	 */
	void updateTotalChance(int totalChance);
