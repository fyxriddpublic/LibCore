 ...
 * 字符串匹配
 */
public class MatcherImpl implements StringMatcher {
    private int mode;
    ...
    public MatcherImpl(String s) {
        ...
        switch (mode) {
            case 1:
                ...
                normalStr = UtilApi.combine(args, " ", 2, args.length-1);
                break;
            case 2:
                pattern = Pattern.compile(UtilApi.combine(args, " ", 1, args.length-1));
                break;
        }
    }
